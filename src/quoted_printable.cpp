...
quoted_printable::quoted_printable(codec::line_len_policy_t encoder_line_policy,
                                   codec::line_len_policy_t decoder_line_policy) :
...
void quoted_printable::q_codec_mode(bool mode) { q_codec_mode_ = mode; }

bool quoted_printable::is_allowed(char ch) const { return ((ch >= SPACE_CHAR && ch <= TILDE_CHAR) || ch == '\t'); }
