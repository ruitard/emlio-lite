...
bool codec::is_8bit_char(char ch) { return static_cast<unsigned>(ch) > 127; }
...
void codec::strict_mode(bool mode) { strict_mode_ = mode; }

bool codec::strict_mode() const { return strict_mode_; }
